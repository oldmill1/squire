...
<div class={styles.splashContainer}>
  <div class={styles.splashContent}>
    ...
    <h1 class={styles.appTitle}>Scribe</h1>
    <p class={styles.appSubtitle}>Write beautifully. Think clearly.</p>
    
    <div class={styles.actionButtons}>
      <button class={styles.primaryButton} onclick={() => goto('/draft')}>
        New Draft
      </button>
      <button class={styles.secondaryButton} onclick={() => console.log('Open drafts')}>
        Open Drafts
      </button>
      <button class={styles.textButton} onclick={() => console.log('About')}>
        About Scribe
      </button>
    </div>
